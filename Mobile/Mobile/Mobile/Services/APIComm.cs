...
namespace Mobile.Services
{
    internal class APIComm
    {
        ...
        public class CallPostAsync2_Results
        {
        ...
        internal static async Task<CallPostAsync2_Results> CallPostAsync(Object objToConvertToJSON, string RelativePath, Boolean ThrowAnyError = false)
        {
        ...
        internal static async Task<CallPostAsync2_Results> CallPostAsync(Object objToConvertToJSON, Uri RequestURI, Boolean ThrowAnyError = false)
        {
            return await CallPostAsync(Newtonsoft.Json.JsonConvert.SerializeObject(objToConvertToJSON), RequestURI, ThrowAnyError = false);
        }
            internal static async Task<CallPostAsync2_Results> CallPostAsync(String JSONData, Uri RequestURI, Boolean ThrowAnyError = false)
        {
           
            CallPostAsync2_Results Res = new CallPostAsync2_Results();
